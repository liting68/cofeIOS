...
- (void)setMessageModel:(MessageModel *)messageModel
{
    ...
    if (messageModel.headImageURL) {
        ...
        [self.headImageView setURL:[messageModel.headImageURL absoluteString]  defaultImage:@"chatListCellHead" type:1];
        
       // [self.headImageView setURL:messageModel.headImageURL fillType:UIImageResizeFillTypeFillIn options:WTURLImageViewOptionAnimateEvenCache placeholderImage:placeholderImage failedImage:placeholderImage diskCacheTimeoutInterval:100 * 24 * 60 * 60 * 1000];
    
    }else {
        
        [self.headImageView setURL:nil  defaultImage:@"chatListCellHead" type:1];
