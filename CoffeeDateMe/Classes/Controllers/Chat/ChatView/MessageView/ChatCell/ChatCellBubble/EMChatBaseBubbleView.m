...
- (void)setModel:(MessageModel *)model
{
  ...
  //  25,80, 10,20
    ...
    if (isReceiver) { ///接收者
        ...
        self.backImageView.image = [TTImage(imageName) resizableImageWithCapInsets:UIEdgeInsetsMake(10, 25, 20, 80) resizingMode:UIImageResizingModeStretch];
        
    }else {
        
        self.backImageView.image = [TTImage(imageName) resizableImageWithCapInsets:UIEdgeInsetsMake(25, 25, 100, 90) resizingMode:UIImageResizingModeStretch];
