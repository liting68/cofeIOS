...
- (void)viewDidLoad
{
    ...
    UIImageView * imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, K_UIMAINSCREEN_WIDTH, K_UIMAINSCREEN_HEIGHT)];
    imageView.image = TTImage(@"chat_voice_bg");
...
- (DXMessageToolBar *)chatToolBar
{
    if (_chatToolBar == nil) {
        ...
        _chatToolBar.backgroundColor = [UIColor colorWithWhite:0.961 alpha:1.000];
        ...
        _chatToolBar.moreView.backgroundColor = [UIColor colorWithHexString:@"0xe8e8e8"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.row < [self.dataSource count]) {
        ...
        if ([obj isKindOfClass:[NSString class]]) {
            ...
            if ([AppUtil isNotNull: [[[NSUserDefaults standardUserDefaults] userInfo] valueForKey:@"head_photo"]]) {
                
                headPhoto  = [[[NSUserDefaults standardUserDefaults] userInfo] valueForKey:@"head_photo"];
...
- (void) URLImageViewDidClicked : (WTURLImageView*)imageView {
    ...
    if (imageView.tag == 8001) {//自己的
       ...
       UserCenterVC * otherUserViewController = [self getStoryBoardControllerWithControllerID:@"UserCenterVC" storyBoardName:@"Other"];
        ...
        otherUserViewController.otherID = self.userID;
