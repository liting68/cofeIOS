...
static NVSlideMenuController * sliderMenuController = nil;
...
+(id)shareController {
    ...
    return sliderMenuController;
}

- (id)defaultMenuViewController:(UIViewController *)menuViewController andContentViewController:(UIViewController *)contentViewController {
    
    if (sliderMenuController) {
        
        return sliderMenuController;
    }
    
    sliderMenuController = [[NVSlideMenuController alloc] initWithMenuViewController:menuViewController andContentViewController:contentViewController];
...
- (void)layoutMenuViewController:(UIViewController *)menuViewController andContentViewController:(UIViewController *)contentViewController
{
    self.menuViewController = menuViewController;
    self.contentViewController = contentViewController;
    self.panGestureEnabled = YES;
...
- (void)closeMenuBehindRootViewController:(UIViewController *)contentViewController animated:(BOOL)animated completion:(void(^)(BOOL finished))completion
{
	[self closeMenuBehindContentViewController:contentViewController animated:animated bounce:self.bounceWhenNavigating completion:completion];
