    ...
    dispatch_async(self.searchQueue, ^{
        if (string.length == 0) {
            ...
            for (int index = 0; index < [dataSource count]; index ++) {
                ...
                if ([AppUtil isNotNull:[userIn valueForKey:@"nick_name"]]) {
                    
                    NSString * nickName = [userIn valueForKey:@"nick_name"];
                ...
                if (!isAdd) {
                    ...
                    if ([AppUtil isNotNull:[userIn valueForKey:@"user_name"]]) {
                        
                        NSString * nickName = [userIn valueForKey:@"user_name"];
